...
var map = new ol.Map({
    ...
    view: new ol.View({
        maxZoom: 28,
        minZoom: 1,
        center: ol.proj.fromLonLat([34.7, 31.4]),
        zoom: 8.2
    }) 
});
...
// map.getView().fit([-19985762.363006, -18163658.681390, 19943102.369982, 21690838.658597], map.getSize());
// map.getView().setCenter(ol.proj.fromLonLat([32, 34]));
